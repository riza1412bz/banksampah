    ...
    */
    ...
    'connections' => [
        ...
        'sqlite' => [
            ...
            // Optimasi concurrency SQLite: WAL + busy_timeout mencegah "database is locked"
            // saat queue (database) & cache (database) bersamaan menahan lock.
            'busy_timeout' => 5000,
            'journal_mode' => 'WAL',
            'synchronous' => 'NORMAL',
        ...
        // Terkunci khusus untuk proyek Bank Sampah: https://ipwickemvyiwrnzhjilo.supabase.co
        'supabase' => [
            'driver' => 'pgsql',
            'url' => env('SUPABASE_DB_URL'),
            'host' => env('SUPABASE_DB_HOST', env('DB_HOST', 'db.ipwickemvyiwrnzhjilo.supabase.co')),
